/** Class for H5P Ace-Editor-Widget */
export default class CodeWidget {
  ...
  constructor(parent, field, params, setValue) {
    ...
    const language = (field.options !== undefined && field.options[0].language !== undefined) ? field.options[0].language : 'python';
    const showAlways = (field.options !== undefined && field.options[0].language !== undefined) ? field.options[0].showAlways : false;
    this.editor = new H5PEditor.CodeWidgetAce(this.wrapper, language, this, {
      code: this.params,
      manualSetup: true,
      hasButtons: false,
      hasConsole: false,
